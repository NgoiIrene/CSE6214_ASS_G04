...
export default function OrderHistoryScreen() {
  ...
  // 模拟数据：为了展示 Tab 效果，这里加了一个 "Processing" 的 Active 订单
  const orders = [
    ...
    try {
        ...
        <html>
          <body style="font-family: Helvetica, sans-serif; padding: 30px; color: #333;">
            ...
            <table style="width: 100%; text-align: left; margin-bottom: 20px;">
              ...
              <tr>
                <td>Mock Item 1 (Food)</td>
                <td style="text-align: right;">RM 12.00</td>
              </tr>
              <tr>
                <td>Mock Item 2 (Beverage)</td>
      ...
      if (isAvailable) {
        await Sharing.shareAsync(uri, {
          ...
          dialogTitle: `Save E-Invoice #${order.id}`, // ✅ 已修复
          UTI: 'com.adobe.pdf'
        });
      } else {
  ...
  const handleSubmitReview = () => {
    ...
    console.log("Data to DB:", reviewData);
    Alert.alert("Success", `Review for ${currentOrderId} submitted!`); // ✅ 已修复
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        <TouchableOpacity
          style={[styles.tabButton, activeTab === 'Past' ? styles.activeTab : null]}
          ...
          <View key={order.id} style={styles.card}>
            ...
            <View style={styles.statusRow}>
              ...
              {order.status === 'Completed' ? (
                ...
                <View style={styles.iconTextWrapper}>
                  ...
                  <Text style={{ color: 'orange', fontWeight: 'bold' }}> {order.status}</Text>
                </View>
              )}
            </View>
            ...
            {order.status === 'Completed' ? (
              <TouchableOpacity style={styles.btnReview} onPress={() => openReviewModal(order.id)}>
                <View style={styles.iconTextWrapper}>
                  <MaterialIcons name="rate-review" size={18} color="black" />
        ...
        >
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              multiline={true}
              numberOfLines={4}
              placeholder="The food is excellent, and the prices are very reasonable for the portions!"
              value={reviewText}
              onChangeText={setReviewText}
              textAlignVertical="top"
            />

            <TouchableOpacity style={styles.btnSubmit} onPress={handleSubmitReview}>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    padding: 15, backgroundColor: 'white', borderBottomWidth: 2, borderColor: 'black'
  },
  headerTitle: { fontSize: 20, fontWeight: 'bold' },

  tabContainer: {
    flexDirection: 'row', alignSelf: 'center', backgroundColor: '#e0e0e0',
    borderRadius: 25, marginVertical: 15, padding: 5
  },
  ...
  btnDownload: {
    flex: 1.3, backgroundColor: '#d3d3d3',
    paddingVertical: 10, paddingHorizontal: 5, borderRadius: 8, justifyContent: 'center', alignItems: 'center', borderWidth: 1
  },

  btnReorder: {
    flex: 0.9, backgroundColor: '#222', paddingVertical: 10, paddingHorizontal: 5, borderRadius: 8, justifyContent: 'center', alignItems: 'center'
  },

  btnReview: {
    backgroundColor: 'white', marginTop: 10,
    padding: 10, borderRadius: 8, justifyContent: 'center', alignItems: 'center', borderWidth: 1
  },
  ...
  modalContent: {
    width: '90%', maxWidth: 400, backgroundColor: 'white', borderRadius: 15,
  ...
  textInput: {
    ...
    height: 100, padding: 10, fontSize: 14, backgroundColor: '#fafafa'
  },
  btnSubmit: {
    backgroundColor: '#222', padding: 15, borderRadius: 10,
